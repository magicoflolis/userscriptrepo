...
( () => {
    ...
    function injectTranslationButton(magicBtn, btContainer, btLang, content, site) {
        ...
        (cfg.display === 'text') ? icons = {
            ...
            mymemory: "",
            translate: "",
        } : (cfg.display === 'icon') ? name = (cfg.translator == 'yandex') ? icons.yandex : (cfg.translator == 'bing') ? icons.bing : (cfg.translator == 'google') ? icons.google : (cfg.translator == 'mymemory') ? icons.mymemory : (cfg.translator == 'translate') ? icons.translate : icons.deepl : name;
    ...
    function injectMenu() {
        ...
        btNav.style = 'position: fixed; z-index: 1000 !important; width: auto; height: auto; top: 0; left: 0; background-color: #000; border: 2px solid #e8eaed; color: #e8eaed;';
