...
async function injectTranslationButton() {
  let content = '',magicBtn,btContainer,btLang,site,
    ...
    name = (TETConfig.translator == 'yandex') ? `Yandex ${icons.yandex}` : (TETConfig.translator == 'bing') ? `Bing ${icons.bing}` : (TETConfig.translator == 'google') ? `Google ${icons.google}` : (TETConfig.translator == 'mymemory') ? `MyMemory ${icons.mymemory}` : (TETConfig.translator == 'translate') ? `translate.com ${icons.translate}` : `DeepL ${icons.deepl}`,
    nIcons = (TETConfig.translator == 'yandex') ? icons.yandex : (TETConfig.translator == 'bing') ? icons.bing : (TETConfig.translator == 'google') ? icons.google : (TETConfig.translator == 'mymemory') ? icons.mymemory : (TETConfig.translator == 'translate') ? icons.translate : icons.deepl,
    checkDisplay = (TETConfig.display == 'text') ? icons = { deepl: '', yandex: '', bing: '', google: '', mymemory: '', translate: '' } : (TETConfig.display == 'icon') ? name = nIcons : false,
  tweetbtn = () => {
