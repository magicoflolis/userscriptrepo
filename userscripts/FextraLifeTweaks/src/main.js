...
const Remove_Clutter = true; // Removes some clutter + wider page
const DisableComments = false; // Disables comments
const AutoScroll = true; // Automatically scrolls on page load
const Scroll_Amount = 202; // Scroll amount for "Top" button.
...
// };
const ael = (elm = document, event, callback) => {
